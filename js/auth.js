...
export async function doReset() {
  var e = document.getElementById('resetEmail').value.trim(), m = document.getElementById('resetMsg'), btn = document.querySelector('#resetWrap .btn-blue');
